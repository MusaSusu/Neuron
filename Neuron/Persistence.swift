...
private let temp = [
    Task1(taskTitle: "Wake up", taskDescription: "Wakey time 10-08",taskIcon: "sun.max.fill", taskDateStart: convertDate(data: "01-07-2023 01:00"),taskDateEnd:convertDate(data: "01-07-2023 01:30"),taskDuration: 0.5, taskColor:[0.949,  0.522,  0.1], taskChecker: false),
    Task1(taskTitle: "Do work", taskDescription: "math",taskIcon: "pencil", taskDateStart:  convertDate(data: "01-07-2023 02:00"),taskDateEnd: convertDate(data: "01-07-2023 03:00"),taskDuration: 1,taskColor:[0.9098, 0.6039,  0.6039], taskChecker: false),
    Task1(taskTitle: "Play games", taskDescription: "Play League",taskIcon: "gamecontroller.fill", taskDateStart: convertDate(data: "01-07-2023 12:20"),taskDateEnd:convertDate(data: "01-07-2023 13:20"),taskDuration: 1,taskColor: [0.32, 0.62,  0.81],taskChecker: false),
    Task1(taskTitle: "Go for a jog", taskDescription: "Light jog at central park",taskIcon: "figure.walk", taskDateStart: convertDate(data: "01-07-2023 13:20"),taskDateEnd: convertDate(data: "01-07-2023 13:50"),taskDuration: 0.5,taskColor: [0.467,  0.867, 0.467],taskChecker: false),
    Task1(taskTitle: "Make dinner", taskDescription: "Fried chicken with legumes",taskIcon: "cooktop.fill", taskDateStart: convertDate(data: "01-07-2023 14:50"),taskDateEnd: convertDate(data: "01-07-2023 15:50"),taskDuration: 1, taskColor: [0.9098, 0.6039,  0.6039],taskChecker: false),
    Task1(taskTitle: "Do laundry", taskDescription: "Remeber to do your laundy",taskIcon: "tshirt.fill", taskDateStart: convertDate(data: "01-07-2023 23:00"),taskDateEnd: convertDate(data: "01-07-2023 23:20"),taskDuration: (1/3), taskColor: [0.9098, 0.6039,  0.6039],taskChecker: false),
